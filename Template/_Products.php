        ...
        <div class="form-row font-size-16 pt-4 font-baloo">
            <div class="col">
                ...
                if (in_array($item['item_id'],$Cart->getCartId($product->getData('cart')) ?? [])){
                    echo '<button type="submit" name="top_sale_submit" disabled class="btn btn-success font-size-16 form-control">In Cart</button>';
                }else{?>
                    <input type="hidden" name="item_id" value="<?= $item['item_id'] ?? '1';?>">
                    <input type="hidden" name="user_id" value="<?= 1;?>">
                    <button type="submit" name="wishList-submit" class="btn btn-warning form-control">Add</button>
                <?php }
                ?>
                </form>
                </div>
                ...
                <form method="post">
                    ...
                    if (in_array($item['item_id'],$Cart->getCartId($product->getData('cart')) ?? [])){
                        ...
                        <input type="hidden" name="item_id" value="<?= $item['item_id'] ?? '1';?>">
                        <input type="hidden" name="user_id" value="<?= 1;?>">
                        <button type="submit" name="product_submit" class="btn btn-warning form-control">Buy</button>
                   <?php }
                    ?>
                </form>
            </div>
